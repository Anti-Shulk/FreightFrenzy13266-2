...
//
//import org.firstinspires.ftc.teamcode.commands.TurretArmCommand;
...
//        command.add(operator.getButton(GamepadKeys.Button.A))
//                .whenPressed(arm::moveHigh);
//
////        BlankButton newButton = (BlankButton) new BlankButton().whenPressed(arm::moveHigh);
//
//
//
//
...
//                        .whenPressed(new TurretArmCommand(turret, arm, operator)));
//
